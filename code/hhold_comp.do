...
save "derived/hh_comp_temp.dta", replace
use "derived/region.dta", clear
merge 1:m hhid using "derived/hh_comp_temp.dta", nogenerate
save "derived/hhold_comp.dta", replace
